...
export function Architecture() {
  ...
  const slideInLeftVariants = {
    hidden: { opacity: 0, x: isMobile ? 0 : -100, y: isMobile ? 30 : 0 },
    visible: {
      opacity: 1,
      x: 0,
      y: 0,
    ...
    <section className="w-full py-12 sm:py-16 md:py-20 px-4 md:px-8 bg-gradient-to-r from-[#FFFFFF] to-[#F0F0F0] overflow-hidden">
      <div className="container mx-auto max-w-6xl">
        ...
        >
          ...
          <motion.div
            className="text-gray-600 text-xs sm:text-sm md:text-base w-full md:w-full mx-auto text-center md:text-left font-[Arial] px-4 sm:px-8 md:px-4"
            variants={itemVariants}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.3 }}
