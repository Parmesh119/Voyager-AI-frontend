  ...
  return (
    <section className="w-full py-20 px-4 md:px-8 bg-gradient-to-r from-[#FFFFFF] to-[#F0F0F0]">
      <div className="container mx-auto max-w-6xl">
        ...
        <h2 className="text-3xl md:text-4xl text-center mb-4 font-[Arial_Rounded_MT_Bold]">
          <span className='font-bold'>Understanding <span className="text-[#2D7DD2]">the Architecture</span></span>
        </h2>

        <p className="text-gray-600 text-center mb-16 max-w-2xl mx-auto font-[Arial]">
          Let's Go Beyond the layers of Voyager to understand how it enables the ability to explore knowledge.
        </p>

        {/* Agents Section */}
        <div className="flex flex-col md:flex-row justify-between items-center mb-20 gap-24">
          <div className="flex flex-col sm:flex-row gap-12 mb-8 md:mb-0 w-full">
            ...
            <svg width="203" height="168" viewBox="0 0 203 168" fill="none" xmlns="http://www.w3.org/2000/svg" className='mx-auto'>
              ...
              <g filter="url(#filter0_d_171_379)">
                <rect x="5" width="193" height="153" rx="20" fill="white" />
                <rect x="5.5" y="0.5" width="192" height="152" rx="19.5" stroke="#EAEAEA" />
              </g>

              <text x="101.5" y="30" font-family="Arial, sans-serif" font-size="14" font-weight="600" text-anchor="middle" fill="#333333">Comparison Agent</text>
              ...
              <defs>
                <filter id="filter0_d_171_379" x="0" y="0" width="203" height="168" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
            ...
            <svg width="203" height="168" viewBox="0 0 203 168" fill="none" xmlns="http://www.w3.org/2000/svg" className='mx-auto'>
              ...
              <text x="101.5" y="30" font-family="Arial, sans-serif" font-size="14" font-weight="600" text-anchor="middle" fill="#333333">Horizon Agent</text>
            ...
            <svg width="203" height="168" className='mx-auto' viewBox="0 0 203 168" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <text x="101.5" y="30" font-family="Arial, sans-serif" font-size="14" font-weight="600" text-anchor="middle" fill="#333333">Analysis Agent</text>
          ...
          <div className="text-gray-600 text-md w-full md:w-full mx-auto md:mx-0 text-center md:text-justify font-[Arial]">
          ...
          <div className="relative w-[500px] h-[381px]">
            <svg width="500" height="381" viewBox="0 0 459 381" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <g transform="translate(139.5, 115)">
                <g clipPath="url(#clip0_240_442)" filter="url(#filter0_i_240_442)">
              ...
              <defs>
                <filter id="filter0_d_171_390" x="0" y="0" width="459" height="381" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                ...
                <filter id="filter0_i_240_442" x="0" y="0" width="180" height="190" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                  <feFlood floodOpacity="0" result="BackgroundImageFix" />
        ...
        <div className="flex lg:flex-row-reverse flex-col gap-20 lg:pl-48 items-center text-justify m-auto">
          <div className="shadow-lg bg-[#75AA00] rounded-2xl order-1 md:order-2 w-full lg:w-1/2 text-center p-12">
            ...
            <svg
              ...
              className="mx-auto"
            >
              <g filter="url(#filter0_i_318_762_inner)">
                <path
          ...
          <div className="order-2 md:order-1 lg:w-1/2">
            <p className="text-gray-600 text-lg font-[Arial]">
