  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-6xl">
        <div
          className={`flex justify-center mb-8 md:mb-12 transition-all duration-500 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}
        ...
        <div className="flex flex-col items-center mb-8 md:mb-16 max-w-3xl mx-auto">
          <div
            className={`grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-8 w-full max-w-3xl transition-all duration-500 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
            style={{ willChange: 'opacity, transform' }}
          >
            {['summarize', 'analyze', 'recommend'].map((tab, index) => (
              ...
              >
                <button
                  ...
                  className={`text-2xl md:text-3xl lg:text-4xl font-bold transition-all duration-300 ease-out hover:scale-105 active:scale-95 relative ${activeTab === tab
                ...
                >
                  ...
                  <span
                    className={`absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-12 md:w-16 h-1 bg-gradient-to-r from-[#6CC644] to-[#3EC6E0] rounded-full transition-all duration-300 ease-in-out ${activeTab === tab ? 'opacity-100 scale-100' : 'opacity-0 scale-0'
                      }`}
                    style={{ willChange: 'opacity, transform' }}
                  ></span>
                </button>
          ...
          <div
            className={`w-full mt-8 md:mt-12 transition-all duration-500 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
              }`}
            style={{
              ...
              <Card className="bg-white shadow-lg rounded-2xl md:rounded-3xl overflow-hidden w-full text-wrap">
                <CardContent className="p-6 md:p-12 text-center relative h-auto min-h-[160px] md:h-48 flex items-center justify-center">
                  {Object.keys(contentMap).map((key) => (
                    <div
                      key={key}
                      className={`absolute font-[Arial] inset-0 flex items-center justify-center text-gray-600 transition-all duration-500 ease-in-out w-full ${activeTab === key
